...
private:
	...
	LPDIRECT3DPIXELSHADER9 waterShader = NULL;
	LPDIRECT3DPIXELSHADER9 greenShader = NULL;
	LPDIRECT3DPIXELSHADER9 idleShader = NULL;
	LPDIRECT3DPIXELSHADER9 terrainShader = NULL;
	...
	std::map<IDirect3DPixelShader9*, std::string> shaderCRCs;
	std::map<IDirect3DVertexShader9*, std::string> vsShaderCRCs;

	std::map<std::string, IDirect3DPixelShader9*> psShaderMods;
	std::map<std::string, IDirect3DVertexShader9*> vsShaderMods;
